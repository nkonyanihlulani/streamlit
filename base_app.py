...
def main():
    ...
    if selection == "Exploratory Data Analysis and Insights":
        ...
        st.markdown(f"""
        <div class="container">
            <img class="logo-img" src="data:image/png;base64,{base64.b64encode(open('Images/format_of_data.png', "rb").read()).decode()}">
        </div>
        """,
            unsafe_allow_html=True)
        ...
        st.markdown(f"""
        <div class="container">
            <img class="logo-img"  src="data:image/png;base64,{base64.b64encode(open('Images/dis_classes.png', "rb").read()).decode()}">
        </div>
        """,
            unsafe_allow_html=True)
        ...
        st.markdown(f"""
        <div class="container">
            <img class="logo-img"  src="data:image/png;base64,{base64.b64encode(open('Images/bar_sent.png', "rb").read()).decode()}">
        </div>
        """,
            unsafe_allow_html=True)
        ...
        st.markdown(f"""
        <div class="container">
            <img class="logo-img"  src="data:image/png;base64,{base64.b64encode(open('Images/box_plot.png', "rb").read()).decode()}">
        </div>
        """,
            unsafe_allow_html=True)
        ...
        st.markdown(f"""
        <div class="container">
            <img class="logo-img"  src="data:image/png;base64,{base64.b64encode(open('Images/word_length.png', "rb").read()).decode()}">
        </div>
        """,
            unsafe_allow_html=True)
        ...
        st.markdown(f"""
        <div class="container">
            <img class="logo-img" src="data:image/png;base64,{base64.b64encode(open('Images/freq.png', "rb").read()).decode()}">
        </div>
        """,
            unsafe_allow_html=True)
        ...
        st.markdown(f"""
        <div class="container">
            <img  class="logo-img"  src="data:image/png;base64,{base64.b64encode(open('Images/Wordclouds.png', "rb").read()).decode()}">
        </div>
        """,
            unsafe_allow_html=True)
        ...
        st.markdown(f"""
        <div class="container">
            <img class="logo-img"  src="data:image/png;base64,{base64.b64encode(open('Images/at.png', "rb").read()).decode()}">
        </div>
        """,
            unsafe_allow_html=True)
        ...
        st.markdown(f"""
        <div class="container">
            <img class="logo-img" src="data:image/png;base64,{base64.b64encode(open('Images/hashtag.png', "rb").read()).decode()}">
        </div>
        """,
            unsafe_allow_html=True)
        ...
        st.markdown(f"""
        <div class="container">
            <img class="logo-img" src="data:image/png;base64,{base64.b64encode(open('Images/polarity.png', "rb").read()).decode()}">
